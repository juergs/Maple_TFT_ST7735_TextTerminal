...
//#include "C:\Users\js\Documents\Arduino\hardware\Arduino_STM32\STM32F1\libraries\Adafruit_GFX_AS\Adafruit_GFX_AS.h"

#include <SPI.h> // hier fehlen write + write16
...
#define ILI9341_TFTWIDTH  128 			//240
#define ILI9341_TFTHEIGHT 160			//320
...
inline void    spiwrite16(uint16_t c) { mSPI.write16(c); } // 8 bit mode
 ...
 //void  writecommand(uint8_t c),commandList(uint8_t *addr);
