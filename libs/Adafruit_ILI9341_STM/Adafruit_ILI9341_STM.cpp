...
//20200507: juergs added. for aliexpresss 7735 TFT. 
void Adafruit_ILI9341_STM::fillScreen2(uint16_t color)
{
  lineBuffer[0] = color;
...
{
  rotation = m % 8; // can't be higher than 3
  switch (rotation) {
    case 0:
	...
	case 7:
	/*
		siehe auch erste Zeile! setrotation!
		https://github.com/Bodmer/TFT_eSPI/blob/master/TFT_Drivers/ILI9163_Defines.h
	...
	*/
		...
		//_width  = 160;  // _init_height;
		//_height = 128; //init_width;
		_width  = ILI9341_TFTHEIGHT;
		_height = ILI9341_TFTWIDTH;
